...
class MaterialStockTakePolicy
{
    ...
    {
        return $user->hasPermission('view_material_stock_takes');
    }
    ...
    {
        return $user->hasPermission('create_material_stock_takes');
    }
    ...
    {
        return $user->hasPermission('edit_material_stock_takes');
    }
