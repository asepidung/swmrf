...
class PurchaseProductExporter extends Exporter
{
    ...
    {
        $body = 'Your purchase product export has completed and ' . number_format($export->successful_rows) . ' ' . str('row')->plural($export->successful_rows) . ' exported.';
