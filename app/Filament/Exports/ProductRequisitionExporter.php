...
class ProductRequisitionExporter extends Exporter
{
    ...
    {
        $body = 'Your product requisition export has completed and ' . number_format($export->successful_rows) . ' ' . str('row')->plural($export->successful_rows) . ' exported.';
