...
$prefix = "MT-" . $currentYear; // Misalnya: BN240229

// Menghitung jumlah data yang ada pada tahun berjalan, termasuk yang sudah dihapus
$sql = mysqli_query($conn, "SELECT COUNT(*) as total FROM mutasi WHERE YEAR(creatime) = YEAR(CURRENT_DATE)");
...
$kodeauto = $prefix . sprintf("%03s", $urut); // Format 3 digit: BN240229001
