...
/* ==========================================================
   1) Ambil data label boning
   ========================================================== */
$sql = "SELECT b.idbarang, b.nmbarang, l.qty, l.pcs
        FROM labelboning l
...
/* ==========================================================
   2) Ambil daftar rawmate (dropdown Material Tambahan)
   ========================================================== */
$rawOptions = "";
$qraw = $conn->query("
...
/* ==========================================================
   3) Deteksi bahan BOM untuk isi tabel utama
   ========================================================== */
...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h4>Pemakaian Bahan (Editable) — BN<?= htmlspecialchars($idboningWithPrefix) ?></h4>
    ...
    <section class="content">
        <div class="container-fluid">
            <form method="post" action="save_rawusage.php" id="usageForm">
