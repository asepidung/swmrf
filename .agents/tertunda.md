...
| **Retur BELI ke supplier** (disebut Owner 17 Sep 2026 sambil membahas Plan Sales Return) | Modul ketiga kandidat sejenis Plan/Sales Return, tapi untuk arah sebaliknya (retur barang ke pemasok). Owner masih menimbang, belum pernah ada kejadian yang membutuhkannya. **Sengaja ditunda sampai ada kejadian pertama** -- jangan dirancang duluan tanpa kasus nyata |
