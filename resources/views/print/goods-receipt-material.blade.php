...
<head>
    <meta charset="utf-8">
    <title>GRM - {{ $record->gr_number }} - {{ $record->supplier->name ?? 'Unknown' }}</title>
...
<body>
    ...
    <div class="doc">
        ...
        <div class="title">
            <h1>Good Receipt Material (GRM)</h1>
        ...
        <dl class="meta">
            ...
            <dd>{{ $record->purchaseMaterial->po_number ?? '-' }}</dd>
        ...
        <table class="items-table">
            ...
            <tbody>
                ...
                @php
                    $poItem = \App\Models\PurchaseMaterialItem::where('purchase_material_id', $record->purchase_material_id)
                ...
                <tr>
                    ...
                    <td style="font-weight: bold; font-size: 11px;">{{ $item->material->name ?? '-' }}</td>
                ...
                @empty
                <tr>
                    <td colspan="6" class="center" style="color:#888; padding: 20px;">Tidak ada data material yang diterima.</td>
                </tr>
                @endforelse
            </tbody>
            <tfoot>
