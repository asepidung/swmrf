                ...
                >
                    ...
                    @if (($records !== null) && count($records))
                        ...
                        @foreach ($records as $record)
                            ...
                            @if ($recordGroupTitle !== $previousRecordGroupTitle)
                                {{-- Skip rendering group summary row since totals are printed inline on the category row --}}
                                ...
                                @if (! $isGroupsOnly)
                                    <x-filament-tables::row>
                                        ...
                                        @php
                                            $customHeaderColspan = 2;
                                            
                                            $extraCellsCountBefore = 0;
                                            if ($isReordering) {
                                                $extraCellsCountBefore++;
                                            }
                                            if (count($actions) && in_array($actionsPosition, [ActionsPosition::BeforeCells, ActionsPosition::BeforeColumns])) {
                                                $extraCellsCountBefore++;
                                            }
                                        ...
                                        @php
                                            $sums = \App\Filament\Admin\Resources\BeefStockResource::getCategorySums($this, $recordGroupTitle);
                                        @endphp
                                        <td
                                                ...
                                                @if ($group->isCollapsible())
                                                    ...
                                                    >
                                                        <x-filament::icon
                                                            ...
                                                            ::class="isGroupCollapsed(@js($recordGroupTitle)) && 'rotate-180'"
                                                        />
                                                    </button>
                                                @endif
                                        ...
                                        @php
                                            $extraCellsCountAfter = 0;
                                            if (count($actions) && in_array($actionsPosition, [ActionsPosition::AfterColumns, ActionsPosition::AfterCells])) {
                                                $extraCellsCountAfter++;
                                            }
                                            if ($isSelectionEnabled && $recordCheckboxPosition === RecordCheckboxPosition::AfterCells) {
                                                $extraCellsCountAfter++;
                                            }
                        ...
                        {{-- Skip rendering group summary row --}}
