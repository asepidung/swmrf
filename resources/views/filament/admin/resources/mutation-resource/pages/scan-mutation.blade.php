        ...
        <div class="grid grid-cols-1 xl:grid-cols-3 gap-6 items-start">
            ...
            <div class="xl:col-span-1 space-y-6 sticky top-6">
                ...
                <x-filament::section>
                    ...
                    <div class="space-y-4">
                        <div>
                            <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Nomor Mutasi</p>
                            <p class="text-lg font-bold text-gray-900 dark:text-white">{{ $record->mutation_number }}</p>
                        </div>
                        <div>
                            <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Tanggal</p>
                            <p class="text-base font-semibold text-gray-900 dark:text-white">{{ $record->mutation_date->format('d F Y') }}</p>
                        </div>
                        <div class="pt-4 border-t border-gray-200 dark:border-white/10">
                            <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Dari Gudang (Asal)</p>
                        ...
                        <div>
                            <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Ke Gudang (Tujuan)</p>
                            <div class="flex items-center gap-2 mt-1">
