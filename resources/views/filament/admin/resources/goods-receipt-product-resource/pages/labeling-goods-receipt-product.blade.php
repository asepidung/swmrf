<x-filament-panels::page>
    ...
    {{--
        ...
        dioperasikan dari layar lebar (form input + tabel label
        berdampingan, kolom kiri sticky). Bukan dibuat responsif -- ditambah
        peringatan supaya yang membuka dari HP sadar sebelum lanjut, dengan
        pilihan tetap meneruskan kalau memang terpaksa. Grid dua kolom di
        bawah TIDAK disentuh sama sekali supaya tata letak desktop tidak
        ikut berubah.
    --}}
    <div
