...
<html>
<head>
    <title>Purchase Material Items Detail List</title>
    <style>
...
<body>
    <h2>Purchase Material Items Detail List</h2>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><strong>{{ optional($record->purchaseMaterial)->po_number ?? '-' }}</strong></td>
