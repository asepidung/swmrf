...
<html>
<head>
    <title>Material Receipt Items Detail List</title>
    <style>
...
<body>
    <h2>Material Receipt Items Detail List</h2>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><strong>{{ optional($record->goodsReceiptMaterial)->gr_number ?? '-' }}</strong></td>
                <td>{{ optional($record->goodsReceiptMaterial)->receive_date ? \Carbon\Carbon::parse($record->goodsReceiptMaterial->receive_date)->format('d M Y') : '-' }}</td>
                <td>{{ optional($record->goodsReceiptMaterial)->sj_number ?? '-' }}</td>
