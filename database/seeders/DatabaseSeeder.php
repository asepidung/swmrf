...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $permissions = [
            ...
            ['name' => 'view_product_materials', 'module_name' => 'Bill of Materials', 'description' => 'View bill of materials'],
            ['name' => 'create_product_materials', 'module_name' => 'Bill of Materials', 'description' => 'Create bill of materials'],
            ['name' => 'edit_product_materials', 'module_name' => 'Bill of Materials', 'description' => 'Edit bill of materials'],
            ['name' => 'delete_product_materials', 'module_name' => 'Bill of Materials', 'description' => 'Delete bill of materials'],
